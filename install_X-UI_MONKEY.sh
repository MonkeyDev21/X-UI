...
ufw allow 80
echo -e "${tim}════════════════════════════════════════════════════    ${plain}"           
echo -e "${vang}✔•MONKEYDEV Đã Hoàn Tất Cài Đặt X-UI•✔ ${plain}" 
echo -e "${tim}════════════════════════════════════════════════════    ${plain}"
...
echo -e "➢Tham Gia Nhóm Hỗ Trợ Tại: ${vang}MONKEYDEV.DEVELOPER ${plain} "
echo -e "▂ ▄ ▅ ▇【Copyright © MONKEYDEV】▇ ▆ ▄ ▂   "
echo -e "${tim}════════════════════════════════════════════════════    ${plain}"
